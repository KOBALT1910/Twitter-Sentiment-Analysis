...
max Accuracy ~0.72-0.73 cвязываю с данными. Модели чаще ошибаются, смотря на обрывки адекватных (а иногда и не очень) фраз с грамматическими ошибками. Если применить модель с biLSTM к полноценным большим отзывам (например, ревью фильма), то Accuracy будет ~0.96-0.97. Всё вышесказанное относится к бинарной классификации. Для многоклассовая классификации даже на 5 классов точность будет сильно падать.
_________________________________________________________________________________________________________________________
